...
exports.up = function (knex) {
    ...
    return Promise.all([
        ...
        knex.schema.hasTable('tb_komponen').then((exists) => {
            ...
            if (!exists) {
                return knex.schema.createTable('tb_komponen', (table) => {
                    ...
                    table.increments('id').unsigned().primary().notNullable();
                    table.string('kategori', 255).notNullable();
        ...
        knex.schema.hasTable('tb_logging').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_logging', (table) => {

                    table.increments('id').unsigned().primary().notNullable();
                    table.string('jenis', 50).nullable;
                    table.string('kategori',50).nullable;
                    table.string('item',255).nullable();
                    table.text('deskripsi', 'longtext').nullable(); // di MySQL bisa atur jenis: tinytext, text, mediumtext, longtext
        ...
        knex.schema.hasTable('tb_opendata_dataset_download').then((exists) => {
            ...
            if (!exists) {
                return knex.schema.createTable('tb_opendata_dataset_download', (table) => {
                    ...
                    table.increments('id').unsigned().primary().notNullable();
                    table.bigInteger('id_dataset',20).notNullable();
        ...
        knex.schema.hasTable('tb_opendata_dataset_permohonan').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_opendata_dataset_permohonan', (table) => {

                    table.increments('id_permohonan').unsigned().primary().notNullable();
                    table.string('nomor_tiket',100).nullable();
                    ...
                    table.string('paham_opd',10).nullable();
                    table.string('opd',10).nullable();
                    table.text('deskripsi','longtext').nullable();
                    table.string('tujuan',50).nullable();
                    table.string('dihubungi',10).nullable();
                    table.string('status',10).nullable();
                    table.timestamp('created_at').notNullable().defaultTo(knex.fn.now());
                    table.timestamp('updated_at').notNullable().defaultTo(knex.raw('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'));
                })
                    .then(() => console.info('\x1b[33m tb_opendata_dataset_permohonan has been created \x1b[0m'));
            }
        }),
        knex.schema.hasTable('tb_opendata_dataset_permohonan_tiket').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_opendata_dataset_permohonan_tiket', (table) => {

                    table.increments('id_permohonan').unsigned().primary().notNullable();
                    table.string('nomor_tiket',100).nullable();
                    table.string('from', 50).nullable();
                    table.string('to',50).nullable();
                    table.text('pesan','longtext').nullable();
                    table.string('status',10).nullable();
                    table.timestamp('created_at').notNullable().defaultTo(knex.fn.now());
                    table.timestamp('updated_at').notNullable().defaultTo(knex.raw('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'));
                })
                    .then(() => console.info('\x1b[33m tb_opendata_dataset_permohonan_tiket has been created \x1b[0m'));
            }
        }),
        ...
        knex.schema.hasTable('tb_opendata_infografik').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_opendata_infografik', (table) => {

                    table.increments('id_infografik').unsigned().primary().notNullable();
                    table.integer('topik',10).notNullable();
                    table.string('title',255).notNullable();
                    ...
                    table.string('images_b',255).nullable();
                    table.string('images_c',255).nullable();
                    table.string('images_d',255).nullable();
                    ...
                    .then(() => console.info('\x1b[33m tb_opendata_infografik has been created \x1b[0m'));
            }
        }),
        knex.schema.hasTable('tb_opendata_infografik_download').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_opendata_infografik_download', (table) => {

                    table.increments('id').unsigned().primary().notNullable();
                    table.integer('id_infografik').notNullable();
                    table.string('ip_address',50).nullable();
                    table.text('user_agent', 'longtext').nullable();
                    table.date('visited_at').nullable();
                    table.timestamp('created_at').notNullable().defaultTo(knex.fn.now());
                    ...
                    .then(() => console.info('\x1b[33m tb_opendata_infografik_download has been created \x1b[0m'));
            }
        }),
        knex.schema.hasTable('tb_opendata_infografik_visitors').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_opendata_infografik_visitors', (table) => {

                    table.increments('id').unsigned().primary().notNullable();
                    table.bigInteger('id_infografik',20).notNullable();
                    table.string('ip_address',50).nullable();
                    table.text('user_agent', 'longtext').nullable();
                    table.date('visited_at').defaultTo(knex.fn.now());
                    table.integer('admin').notNullable().defaultTo(0);
                    ...
                    .then(() => console.info('\x1b[33m tb_opendata_infografik_visitors has been created \x1b[0m'));
            }
        }),
        ...
        knex.schema.hasTable('tb_satupeta_bantuan').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_satupeta_bantuan', (table) => {
        ...
        knex.schema.hasTable('tb_satupeta_locations').then((exists) => {
            ...
            if (!exists) {
                return knex.schema.createTable('tb_satupeta_locations', (table) => {
                    ...
                    table.integer('admin').notNullable().defaultTo(0);
                    table.string('visibilitas',20).notNullable();
                    table.timestamp('created_at').notNullable().defaultTo(knex.fn.now());
                    table
                        .timestamp('updated_at')
                        .notNullable()
        ...
        knex.schema.hasTable('tb_satupeta_location_geospasial').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_satupeta_location_geospasial', (table) => {

                    table.increments('id_location_geospasial').unsigned().primary().notNullable();
                    table.string('jenis', 50).notNullable();
                    table.string('nama_geospasial', 255).notNullable();
                    table.text('geojson').nullable();
                    table.integer('id_maplist').notNullable();
                    table.integer('luas_area').nullable();
                    table.string('satuan', 50).nullable(); // pakai YEAR biar sesuai MySQL
                    table.integer('kecamatan_id', 6).notNullable();
                    table.bigInteger('desa_id', 20).notNullable();
        ...
        knex.schema.hasTable('tb_satupeta_location_jenis').then((exists) => {

            if (!exists) {
                return knex.schema.createTable('tb_satupeta_location_jenis', (table) => {

                    table.increments('id_jenis').unsigned().primary().notNullable();
                    table.string('nama_jenis', 50).notNullable();
                    ...
                    .then(() =>
                        console.info('\x1b[33m tb_satupeta_location_jenis has been created \x1b[0m')
                    );
            }
        }),
        knex.schema.hasTable('tb_satupeta_location_maplist').then((exists) => {
            ...
            if (!exists) {
                return knex.schema.createTable('tb_satupeta_location_maplist', (table) => {
                    ...
                    table.string('title', 255).notNullable();
                    table.integer('satker_id').notNullable();
                    table.integer('sektor_id').notNullable();
...
exports.down = function (knex) {
    ...
    return Promise.all([
        ...
        knex.schema.dropTableIfExists('tb_opendata_infografik'),
        knex.schema.dropTableIfExists('tb_opendata_infografik_visitors'),
        ...
        knex.schema.dropTableIfExists('tb_satupeta_location_geospasial'),
