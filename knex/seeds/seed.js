...
//const tb_opendata_infografik = require('../default-data-json/tb_opendata_infografik.json');
...
const tb_satupeta_bantuan = require('../default-data-json/tb_satupeta_bantuan.json');
...
const tb_satupeta_location_geospasial = require('../default-data-json/tb_satupeta_location_geospasial.json');
...
exports.seed = async function (knex) {
    ...
    //await knex('tb_opendata_infografik').del();
    await knex('tb_opendata_menu').del();
    await knex('tb_opendata_setting').del();
    //await knex('tb_satupeta_artikel').del();
    //await knex('tb_satupeta_feedback').del();
    await knex('tb_satupeta_bantuan').del();
    ...
    await knex('tb_satupeta_location_geospasial').del();
    ...
    //await knex('tb_opendata_infografik').insert(tb_opendata_infografik);
    ...
    await knex('tb_satupeta_bantuan').insert(tb_satupeta_bantuan);
    ...
    await knex('tb_satupeta_location_geospasial').insert(tb_satupeta_location_geospasial);
